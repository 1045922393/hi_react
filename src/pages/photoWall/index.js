...
function PhotoWall() {
  ...
  useEffect(() => {
    ...
    (function () {
      ...
      Diapo.prototype.draw = function () {
        ...
        if (
          ...
          this.light =
            0.5 +
            Math.abs(this.normalZ * camera.cosY - this.normalX * camera.sinY) *
              0.6;
          // ---- draw image ----
          this.visible = true;
          this.img.draw();
    ...
    return () => {
      operateDocClass("html", "remove", "html_photoWall_extends");
      operateDocClass("body", "remove", "body_photoWall_extends");
    };
  });
  return (
    <>
